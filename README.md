...
- Se a opcao estiver marcada, repositorios sem release com `.exe` tambem sao verificados pela arvore de arquivos.
...
Para repositorios privados, informe um token GitHub com permissao de leitura de repositorios.
